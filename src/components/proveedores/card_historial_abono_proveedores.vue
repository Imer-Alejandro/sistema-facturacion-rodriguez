<script>
import OptionesHistorialAbono from './optiones_hist_abono_proveedor.vue'
...
export default {
    ...
    mounted(){
        ...
        emitter.on('cerrar-menu-optiones-abono-proveedor', (emisor) => {
                if (emisor !== this) {
    ...
    data(){ 
        return{
            ...
            idRegistroAbono:this.abono.id_abono_deuda_a_proveedor
    ...
    methods:{
        abrir_y_cerrar_optiones_abonos(){
            ...
            if (this.visibilidadOptiones) {
                ...
                emitter.emit('cerrar-menu-optiones-abono-proveedor', this);
            }
        },
